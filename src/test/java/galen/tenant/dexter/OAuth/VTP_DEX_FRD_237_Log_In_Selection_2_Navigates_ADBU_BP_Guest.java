...
public class VTP_DEX_FRD_237_Log_In_Selection_2_Navigates_ADBU_BP_Guest extends BaseTest {
    ...
    public void VTP_DEX_FRD_237_Log_In_Selection_2_Navigates_ADBU_BP_Guest_Test() throws Exception {
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.obesity, report);
        user.weight = "212";
        pageObj.obesity.enterHeightAndWeight(user, report);
        pageObj.obesity.clickNextToPage(pageObj.ddiCondition, report);
        new DexterNavigations(driver).DDIPath(user, pageObj.antifungal, null);
        new DexterHFWrappers(driver).runAntifungalToADBU(user, pageObj.antifungal, pageObj.adbubpScreen, report);
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.adbubpScreen, report);
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.ddiCondition, report);
        ...
        new DexterHFWrappers(driver).runAntifungalToADBU(user, pageObj.otherMedication, pageObj.adbubpScreen,report);
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.antifungal, report);
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.otherMedication, report);
        ...
        new DexterHFWrappers(driver).runAntifungalToADBU(user, pageObj.gallbladder, pageObj.adbubpScreen,report);
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.gallbladder, report);
        pageObj.gallbladder.clickYesNoNextToPage("Yes", pageObj.depression, report);
        new DexterHFWrappers(driver).runAntifungalToADBU(user, pageObj.depression, pageObj.adbubpScreen,report);
        ...
        new DexterHFWrappers(driver).runDexterHFnoBPNonsmoker(user, pageObj.depression, report);
