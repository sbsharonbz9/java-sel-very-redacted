...
public class VTP_DEX_FRD_017_Nav_App_Back_Button extends BaseTest {
    ...
    public void VTP_DEX_FRD_017_Nav_App_Back_Button_Test() throws IOException, InterruptedException {
        ...
        new DxNavigations(driver).partialNavigationIA(user, pageObj.enterBP, report);
        ...
        new DxNavigations(driver).partialNavigationIA(user, pageObj.knowBPNumber, report);
        ...
        commonPageFeatures.clickBackToPage(pageObj.antifungal, report);
        ...
        new DxNavigations(driver).partialNavigationIA(user, pageObj.numbers, report);
        commonPageFeatures.clickMoreInfoToModal(report);
        commonPageFeatures.clickMoreInfoBackToModalDismissed(report);
