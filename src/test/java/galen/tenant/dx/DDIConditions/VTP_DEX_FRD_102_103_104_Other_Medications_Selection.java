...
public class VTP_DEX_FRD_102_103_104_Other_Medications_Selection extends BaseTest {
    ...
    @Test
    public void VTP_DEX_FRD_102_103_104_Other_Medicines_Selection_Test() {

        DxUser user = new DxUserTemplates().createHappyFlow_IA_Initial_Assessment_to_Checkout_wBP_NonSmoker();
        DxPageObj pageObj = new DxPageObj(driver);
        CommonPageFeatures common = new CommonPageFeatures(driver);
        ArrayList<String> allButOther = pageObj.otherMedication.getAllButNone();
        DxHFWrappers wrapper = new DxHFWrappers(driver);

        pageObj.pritUnl.authenticateUserIfRequired(UrlType.DX);
        wrapper.runDxHFNonsmokingwBP(user, pageObj.otherMedication, report);
        ...
        allButOther.forEach((c)-> {
            ...
            wrapper.antiFungalToADBU(user, pageObj.adbu, null);
        ...
        wrapper.antiFungalToADBU(user, pageObj.adbu, report);
