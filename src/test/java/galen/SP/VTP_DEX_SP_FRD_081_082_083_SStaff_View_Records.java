...
public class VTP_DEX_SP_FRD_081_082_083_SStaff_View_Records extends BaseTest {

    public static final String OBJECTIVE =
            "DEX_SP_FRD_055: To verify on the Clinician portal dashboard, if a Clinician " +
                    "user selects the View Records link in the Action column of the Participants " +
                    "screen for a participant, the portal shall navigate to a screen displaying " +
                    "clinician submitted health survey records for that participant.\n" +
                    "DEX_SP_FRD_056: To verify the participant records screen displayed for a " +
                    "Clinician user shall display:\n" +
                    "Participant ID\n" +
                    "Participant Email Address\n" +
                    "A Close Records button at the top of the screen\n" +
                    "An Add Record button\n" +
                    "DEX_SP_FRD_057: To verify the records section of the participant records " +
                    "screen shall contain the following columns:\n" +
    ...
    public static final String NOTES =
            "This protocol contains the following scenarios:\n" +
                    "View Records button navigates to View Records Screen with Health Records " +
                    "displayed\n" +
                    ...
                    "Completed By\n" +
                    "Completed Date\n" +
                    "Clicking Close Record button returns user to Participant Screen";

    static String REQUIREMENTS = "DEX_SP_FRD_081, DEX_SP_FRD_082, DEX_SP_FRD_083";
    static String REFERENCES = "N/A";
    StudyAdminPageObj pageObj;
    String reportName = "VTP_DEX_SP_FRD_081_082_083_SStaff_View_Records";
    ArrayList<String> VERSIONHISTORY = new ArrayList<>();
    HashMap<String, String[]> PREEXECUTION = new HashMap<>();
    public BasicHelpers bh;
    public CommonPageFeatures commonPageFeatures;

    VTP_DEX_SP_FRD_081_082_083_SStaff_View_Records() {
        VERSIONHISTORY.add("1.0;28FEB2023;Initial Test Script – Per 173;Tester");
    }

    @Test
    public void VTP_DEX_SP_FRD_081_082_083_SStaff_View_Records_Test() throws IOException {
        report = new GalenReport(driver, reportName, OBJECTIVE, REQUIREMENTS, REFERENCES, NOTES, VERSIONHISTORY, PREEXECUTION);
        report.reportTitle = "VTP_DEX_SP_FRD_081_082_083_SStaff_View_Records";
