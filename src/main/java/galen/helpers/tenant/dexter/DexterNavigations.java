...
public class DexterNavigations extends Navigations {
    DexterPageObj pages;

    public DexterNavigations(WebDriver driver) {
        super(driver);
        this.pages = new DexterPageObj(driver);
        driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(1));
    }

    public BasePage depressionPath(DexterUser user, BasePage endPage, GalenReport report) {
    ...
    public BasePage DDIPath(DexterUser user, BasePage endPage, @Nullable GalenReport report) {
    ...
    public BasePage antiFungalToADBU(DexterUser user, BasePage endPage, @Nullable GalenReport report) {
    ...
    public BasePage partialNavigationIA(DexterUser user, BasePage endPage, GalenReport report) throws IOException, InterruptedException {
