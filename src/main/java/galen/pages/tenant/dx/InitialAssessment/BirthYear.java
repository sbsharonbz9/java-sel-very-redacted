...
public class BirthYear extends BasePage {
    ...
    public void fillOutBirthday(DxUser user, @Nullable GalenReport report) {
    ...
    public boolean verifyAllQuestionsAnswered(DxUser user, @Nullable GalenReport report) {
    ...
    public boolean fillOutBirthdayAndProgress(DxUser user, BasePage nextPage, @Nullable GalenReport report) {
