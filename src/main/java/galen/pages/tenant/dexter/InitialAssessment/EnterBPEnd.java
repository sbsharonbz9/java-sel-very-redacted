...
public class EnterBPEnd extends EnterBP {
    ...
    public void enterAndVerifyToModal(DexterUser user, @Nullable GalenReport report) {
        enterBP(user, report);
        clickNext(report);
        verifyModalDisplayed(report);
    }

    public void enterAndVerifyToPage(DexterUser user, BasePage toPage, @Nullable GalenReport report) {
